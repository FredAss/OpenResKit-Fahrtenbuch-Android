        ...
        Filter myFilter = new Filter() {
            ...
            public CharSequence convertResultToString(final Object resultValue) {
                if (resultValue == null) {
                    ...
                    Address rv = (Address) resultValue;
                    String returnString = rv.getAddressLine(0);

                    if (rv.getAddressLine(1) != null) {
                        returnString += (", " + rv.getAddressLine(1));
                    }

                    if (rv.getAddressLine(2) != null) {
                        returnString += (", " + rv.getAddressLine(2));
                    }
